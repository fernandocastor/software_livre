...
\pgfdeclareimage[height=0.4cm]{logo3}{cin}
\pgfdeclareimage[height=0.4cm]{utrecht}{utrecht}
%\pgfdeclareimage[height=1.1cm]{logo4}{talk}

\logo{\pgfuseimage{logo3}\hspace{0.1cm}\pgfuseimage{utrecht}}
%\pgfuseimage{logo}\hspace{0.1cm}\hspace{0.1cm}\pgfuseimage{logo2}}
...
\begin{frame}
	...
	\includegraphics[scale=0.35]{oss.jpg}
	    % Fonte: http://mwusers.com/why-i-love-open-source-software/
	    % O copyright desta imagem provavelmente pertence à empresa MWUsers. Por outro lado, ela 
	    % lança mão de múltiplos logotipos e a licença de uso está atrelada às destes. Acredito que
	    % isso se encaixa em fair use, tendo em vista o propósito puramente educacional. 
...
%A Red Hat projeta chegar a um faturamento de US\$ 3 bi. em 2016. Foi comprada pela IBM em julho de 2019 por 34bi.
%(A compra começou a ser efetuada quase um ano antes).
...
% acordo com a lei americana.
	...
	% Posteriormente, comprou a Red Hat, como mencionado acima. 34 bilhões de dólares.
...
% Uma descrição de como foi a criação do termo "open source", 
% pela própria Christine: https://opensource.com/article/18/2/coining-term-open-source-software
	\end{figure}
%\pause
...
%	\begin{figure}
    ...
    %Licença: Creative Commons Attribution
%	\end{figure}
    % Para saber mais sobre distribuições do Linux, em particular, quais são as mais populares, dê uma olhada em 
...
\begin{center}
	...
	% O copyright desta image pertence a mim, Fernando Castor.
	\end{center}
	\end{figure}
\end{frame}
...
%	\begin{center}
	...
	% Copyright (c) Statista
    % http://www.phonesreview.co.uk/2016/08/21/android-smartphones-sales-break-records-in-q2-of-2016/
    %	\end{center}
\pause
	{\footnotesize 
...
%	\item é um ponto de entrada para pessoas conectarem-se à Internet;
	...
	% Sobre a quantidade de dispositivos Android: 
...
\begin{frame}
	\frametitle{Fontes de receita da Apple}
 	...
 	% Fonte: https://www.statista.com/statistics/382136/quarterly-segments-revenue-of-apple/
\end{frame}
